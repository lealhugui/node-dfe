            ...
            if (result.envioNF && result.envioNF.data) {
                ...
                if (arquivos && arquivos.salvar) {
                    ...
                    if ((result.success == true) && (retConsReciNFe.cStat == '104')) {
                        ...
                        const filenameEnvio = `${arquivos.pastaEnvio}${new Date().toISOString()}${((_c = retEnviNFe.infRec) === null || _c === void 0 ? void 0 : _c.nRec) || ''}-enviNFe.xml`;
                        const filenameRetorno = `${arquivos.pastaRetorno}${new Date().toISOString()}${((_d = retEnviNFe.infRec) === null || _d === void 0 ? void 0 : _d.nRec) || ''}-retEnviNFe.xml`;
